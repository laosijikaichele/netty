...
@Fork(1)
public class AdaptiveByteBufAllocatorConcurrentNoCacheNormalThreadsCountBenchmark extends AbstractMicrobenchmark {
    ...
    public AdaptiveByteBufAllocatorConcurrentNoCacheNormalThreadsCountBenchmark() {
        super(false, true);
    }
