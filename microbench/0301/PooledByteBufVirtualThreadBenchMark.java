...
public class PooledByteBufVirtualThreadBenchMark {
    ...
    private static void adaptiveBench() throws InterruptedException {
        long[] durations = new long[TOTAL_ITERATIONS];
        for (int i = 0; i < TOTAL_ITERATIONS; i++) {
            durations[i] = doBench(adaptiveAllocator);
        }
        long sum = 0;
        ...
        System.out.println("Adaptive alloc avg duration: " + sum / BENCH_ITERATIONS);
    }
    ...
    private static long doBench(ByteBufAllocator allocator) throws InterruptedException {
